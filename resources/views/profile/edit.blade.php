                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.update',Auth::user()->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address')  }}" required autocomplete="address">{{ $user->profile->address }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description')  }}" required autocomplete="description">{{ $user->profile->description }}</textarea>
